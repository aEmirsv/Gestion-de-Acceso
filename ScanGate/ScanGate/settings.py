"""
Django settings for ScanGate project.
...
LOGIN_URL = '/login/'  # Asegúrate de que esta URL coincide con tu vista de login
...
WSGI_APPLICATION = 'ScanGate.wsgi.application'
